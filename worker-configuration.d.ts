/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4225ebd597d05b5c97cb213111f23e3d)
// Runtime types generated with workerd@1.20251217.0 2025-12-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CanvasDO" | "SLCAgent";
	}
	interface Env {
		CANVAS_REGISTRY: KVNamespace;
		ANTHROPIC_API_KEY: string;
		CF_ACCOUNT_ID: string;
		CF_GATEWAY_ID: string;
		CF_API_TOKEN: string;
		CF_AIG_TOKEN: string;
		CANVAS: DurableObjectNamespace<import("./worker/index").CanvasDO>;
		SLC_AGENT: DurableObjectNamespace<import("./worker/index").SLCAgent>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_API_KEY" | "CF_ACCOUNT_ID" | "CF_GATEWAY_ID" | "CF_API_TOKEN" | "CF_AIG_TOKEN">> {}
}
